...
## Kurz, ktorý vás naučí všetko, čo potrebujete vedieť, aby ste mohli začať vytvárať AI agentov
...
**Ak chcete, aby boli podporované ďalšie jazyky prekladov, sú uvedené [tu](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md).**
...
[![GitHub hviezdičky](https://img.shields.io/github/stars/microsoft/ai-agents-for-beginners.svg?style=social&label=Star)](https://GitHub.com/microsoft/ai-agents-for-beginners/stargazers/?WT.mc_id=academic-105485-koreyst)
...
Tento kurz obsahuje lekcie, ktoré pokrývajú základy tvorby AI agentov. Každá lekcia pokrýva vlastnú tému, takže začnite kdekoľvek chcete!

Tento kurz podporuje viacero jazykov. Pozrite si naše [dostupné jazyky tu](#-multi-language-support).

Ak je to váš prvýkrát, čo pracujete s generatívnymi AI modelmi, pozrite si náš kurz [Generatívna AI pre začiatočníkov](https://aka.ms/genai-beginners), ktorý obsahuje 21 lekcií o tvorbe s GenAI.

Nezabudnite [ohviezdičkovať (🌟) tento repozitár](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) a [urobiť fork tohto repozitára](https://github.com/microsoft/ai-agents-for-beginners/fork) na spustenie kódu.

### Spoznajte ďalších študentov, získajte odpovede na svoje otázky

Ak sa zaseknete alebo máte otázky ohľadom tvorby AI agentov, pripojte sa k nášmu špeciálnemu Discord kanálu v [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Čo potrebujete

Každá lekcia v tomto kurze obsahuje ukážky kódu, ktoré nájdete v priečinku code_samples. Môžete si [urobiť fork tohto repozitára](https://github.com/microsoft/ai-agents-for-beginners/fork) a vytvoriť si tak vlastnú kópiu.

Ukážky kódu v týchto cvičeniach využívajú Microsoft Agent Framework so službou Microsoft Foundry Agent Service V2:

- [Microsoft Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - vyžaduje Azure účet

Tento kurz používa nasledujúce frameworky a služby AI agentov od Microsoftu:

- [Microsoft Agent Framework (MAF)](https://learn.microsoft.com/agent-framework/overview/)
- [Microsoft Foundry Agent Service V2](https://aka.ms/ai-agents-beginners/ai-agent-service)

Niektoré ukážky kódu podporujú aj alternatívnych poskytovateľov kompatibilných s OpenAI, ako napríklad [MiniMax](https://platform.minimaxi.com/), ktorý ponúka modely s veľkým kontextom (až 204K tokenov). Viac informácií o konfigurácii nájdete v [Course Setup](./00-course-setup/README.md).

Pre viac informácií o spustení kódu ku kurzu navštívte [Course Setup](./00-course-setup/README.md).

## 🙏 Chcete pomôcť?

Máte návrhy alebo ste našli chyby v pravopise alebo kóde? [Vytvorte issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) alebo [podajte pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 Každá lekcia obsahuje

- Písanú lekciu umiestnenú v README a krátke video
- Ukážky kódu v Pythone používajúce Microsoft Agent Framework s Microsoft Foundry
- Odkazy na ďalšie zdroje pre pokračovanie v učení


## 🗃️ Lekcie

| **Lekcia**                                   | **Text a kód**                                    | **Video**                                                  | **Dodatočné učenie**                                                                     |
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Úvod do AI agentov a prípadov ich použitia   | [Odkaz](./01-intro-to-ai-agents/README.md)          | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Preskúmanie agentových AI frameworkov        | [Odkaz](./02-explore-agentic-frameworks/README.md)  | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Pochopenie návrhových vzorov AI agentov      | [Odkaz](./03-agentic-design-patterns/README.md)     | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Návrhový vzor používania nástrojov            | [Odkaz](./04-tool-use/README.md)                    | [Video](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Návrhový vzor plánovania                       | [Odkaz](./07-planning-design/README.md)             | [Video](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Vzorec návrhu metakognície                 | [Link](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Správa agentickej pamäte                      | [Link](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Preskúmanie Microsoft Agent Framework                         | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Vytváranie agentov na použitie počítača (CUA)           | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
...
### Séria Copilot
[![Copilot pre AI párprogramovanie](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Zmluvou o prispievateľovi (CLA), ktorá vyhlasuje, že máte právo a naozaj poskytnete
...
CLA a vhodne označí PR (napr. kontrola stavu, komentár). Jednoducho dodržujte pokyny
poskytované botom. Túto akciu vykonáte iba raz vo všetkých repozitároch používajúcich našu CLA.

Tento projekt prijal [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/).
Pre viac informácií si pozrite [FAQ ku Kodexu správania](https://opensource.microsoft.com/codeofconduct/faq/) alebo
kontaktujte [opencode@microsoft.com](mailto:opencode@microsoft.com) s akýmikoľvek ďalšími otázkami alebo pripomienkami.

## Ochranné známky

Tento projekt môže obsahovať ochranné známky alebo logá projektov, produktov alebo služieb. Autorizované použitie ochranných známok alebo log spoločnosti Microsoft
je podmienené a musí dodržiavať
[Pokyny Microsoft k ochranným známkam a značkám](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Použitie ochranných známok alebo log spoločnosti Microsoft v upravených verziách tohto projektu nesmie spôsobiť zmätok ani naznačovať sponzorstvo spoločnosti Microsoft.
Akékoľvek použitie ochranných známok alebo log tretích strán podlieha pravidlám týchto tretích strán.

## Získavanie pomoci


Ak máte problém alebo otázky ohľadom tvorby AI aplikácií, pridajte sa k:
