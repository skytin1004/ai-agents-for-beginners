...
![AI Agents for Beginners](../../translated_images/sr/repo-thumbnailv3.917487e234b90100.webp)
...
**Ако желите да буду додати још преводних језика, они су наведени [овде](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md).**
...
Овај курс има лекције које покривају основе изградње AI агената. Свака лекција покрива своју тему па почните где год желите!

Постоји подршка за више језика за овај курс. Погледајте наше [доступне језике овде](#-multi-language-support). 

Ако ово правите по први пут са генеративним AI моделима, погледајте наш курс [Generative AI For Beginners](https://aka.ms/genai-beginners), који укључује 21 лекцију о изградњи са GenAI.

Не заборавите да [означите звездицом (🌟) овај репозиторијум](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) и [форкујете овај репозиторијум](https://github.com/microsoft/ai-agents-for-beginners/fork) да бисте покренули код.

### Упознајте друге ученике, добијте одговоре на ваша питања

Ако застанете или имате питања о изградњи AI агената, придружите се нашем посвећеном Discord каналу у [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Шта вам је потребно 

Свака лекција у овом курсу укључује примере кода које можете наћи у фасцикли code_samples. Можете [форковати овај репозиторијум](https://github.com/microsoft/ai-agents-for-beginners/fork) да направите своју копију.  
...
Овај курс користи следеће AI Agent оквире и сервисе од Microsoft-а:

- [Microsoft Agent Framework (MAF)](https://learn.microsoft.com/agent-framework/overview/)
- [Microsoft Foundry Agent Service V2](https://aka.ms/ai-agents-beginners/ai-agent-service)

Неки примерци кода такође подржавају алтернативне провајдере компатибилне са OpenAI као што је [MiniMax](https://platform.minimaxi.com/), који нуди моделе великог контекста (до 204К токена). Погледајте [Course Setup](./00-course-setup/README.md) за детаље конфигурације.
...
- Писани материјал у README-у и кратак видео
- Python примере кода користећи Microsoft Agent Framework са Microsoft Foundry
- Линкове ка додатним ресурсима за даљу едукацију


## 🗃️ Лекције

| **Лекција**                                   | **Текст и код**                                    | **Видео**                                                  | **Додаци за учење**                                                                     |
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Увод у AI агенте и употребне случајеве агената       | [Link](./01-intro-to-ai-agents/README.md)          | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Истраживање AI агентских оквира              | [Link](./02-explore-agentic-frameworks/README.md)  | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Разумевање AI агентских дизајн образаца     | [Link](./03-agentic-design-patterns/README.md)     | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Образац коришћења алата                      | [Link](./04-tool-use/README.md)                    | [Video](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Агентски RAG                                  | [Link](./05-agentic-rag/README.md)                 | [Video](https://youtu.be/WcjAARvdL7I?si=gKPWsQpKiIlDH9A3)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Изградња поузданих AI агената               | [Link](./06-building-trustworthy-agents/README.md) | [Video](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK ) | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Образац планирања дизајна                      | [Link](./07-planning-design/README.md)             | [Video](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Мулти-агентски дизајн образац                   | [Link](./08-multi-agent/README.md)                 | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Мета-метакогниција дизајн шаблон                 | [Линк](./09-metacognition/README.md)               | [Видео](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| AI агенти у производњи                      | [Линк](./10-ai-agents-production/README.md)        | [Видео](https://youtu.be/l4TP6IyJxmQ?si=31dnhexRo6yLRJDl)  | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Коришћење агенцијаких протокола (MCP, A2A и NLWeb) | [Линк](./11-agentic-protocols/README.md)           | [Видео](https://youtu.be/X-Dh9R3Opn8)                                 | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Контекст инжењеринг за AI агенте            | [Линк](./12-context-engineering/README.md)         | [Видео](https://youtu.be/F5zqRV7gEag)                                 | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Управљање агенцијском меморијом                      | [Линк](./13-agent-memory/README.md)     |      [Видео](https://youtu.be/QrYbHesIxpw?si=vЗкVwКrQ4ieCcIPx)                                                      |                                                                                        |
| Истраживање Microsoft Agent Framework                         | [Линк](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Израда агената за коришћење рачунара (CUA)           | [Линк](./15-browser-use/README.md)     |                                                            | [Линк](https://docs.browser-use.com/examples/templates/playwright-integration)         |
| Распоређивање скалабилних агената                    | [Линк](./16-deploying-scalable-agents/README.md) |                                                    | [Линк](https://learn.microsoft.com/azure/ai-foundry/agents/overview)                   |
...
| Осигурање AI агената                           | [Линк](./18-securing-ai-agents/README.md)  |                                                            | [Линк](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Овај пројекат привлачи доприносе и предлоге. Већина доприноса захтева да се сложите са
Уговором о лиценци за допринос (CLA) у коме изјављујете да имате право и заиста нам дајете
права на коришћење вашег доприноса. За детаље посетите <https://cla.opensource.microsoft.com>.

Када пошаљете захтев за укључивање измена (pull request), CLA бот ће аутоматски одредити да ли морате да доставите
CLA и одговарајуће означити PR (на пример, провера статуса, коментар). Једноставно следите упутства
које даје бот. Ово ћете морати да урадите само једном за све репозиторијуме који користе наш CLA.
...
Овај пројекат може садржати заштићене знакове трговине или логотипе пројеката, производа или услуга. Овлашћена употреба Microsoft
знакова трговине или логотипа подлеже и мора следити
[Упутства за коришћење Microsoft знакова трговине и брендова](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Употреба Microsoft знакова трговине или логотипа у измењеним верзијама овог пројекта не сме изазвати конфузију или навести на помисао о Microsoft спонзорству.
Свака употреба знакова трговине или логотипа трећих страна подлеже политикама тих трећих страна.

## Како добити помоћ


Ако сте заглављени или имате било каквих питања о изградњи AI апликација, придружите се:

[![Microsoft Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)

Ако имате повратне информације о производу или сте наишли на грешке приликом израде, посетите:
