...
## Tečaj koji poučava sve što trebate znati za početak izrade AI Agenata
...
**Ako želite podržati dodatne prijevodne jezike, oni su navedeni [ovdje](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md).**
...
Ovaj tečaj sadrži lekcije koje pokrivaju osnove izrade AI agenata. Svaka lekcija obrađuje svoju temu, pa počnite gdje želite!

Za ovaj tečaj postoji višejezična podrška. Pogledajte [dostupne jezike ovdje](#-multi-language-support). 

Ako vam je ovo prvi put da radite s Generativnim AI modelima, pogledajte naš tečaj [Generative AI For Beginners](https://aka.ms/genai-beginners), koji sadrži 21 lekciju o izradi s GenAI.
...
Ako zapnete ili imate pitanja o izradi AI agenata, pridružite se našem Discord kanalu u [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).
...
Ovaj tečaj koristi sljedeće AI Agent okvire i servise iz Microsofta:

- [Microsoft Agent Framework (MAF)](https://learn.microsoft.com/agent-framework/overview/)
- [Microsoft Foundry Agent Service V2](https://aka.ms/ai-agents-beginners/ai-agent-service)

Neki primjeri koda također podržavaju alternativne pružatelje kompatibilne s OpenAI poput [MiniMax](https://platform.minimaxi.com/), koji nudi modele s velikim kontekstom (do 204K tokena). Pogledajte [Postavljanje tečaja](./00-course-setup/README.md) za detalje konfiguracije.

Za više informacija o pokretanju koda za ovaj tečaj, pogledajte [Postavljanje tečaja](./00-course-setup/README.md).

## 🙏 Želite pomoći?

Imate li prijedloge ili ste pronašli pravopisne ili kodne greške? [Podignite issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) ili [Stvorite pull zahtjev](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Primjere Python koda koristeći Microsoft Agent Framework sa Microsoft Foundry
...
| Razumijevanje AI agenata i dizajnerskih obrazaca | [Link](./03-agentic-design-patterns/README.md)     | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Izrada povjerljivih AI agenata                | [Link](./06-building-trustworthy-agents/README.md) | [Video](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK ) | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Višekratni agentski dizajnerski obrazac       | [Link](./08-multi-agent/README.md)                 | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Metakognitivni dizajnerski obrazac             | [Link](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Sigurnost AI agenata                           | [Link](./18-securing-ai-agents/README.md)  |                                                            | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Ovaj projekt dobrodošao doprinosima i sugestijama. Većina doprinosa zahtijeva da se složite s
Ugovorom o licenci za doprinositelje (CLA) kojim izjavljujete da imate pravo, i zaista dajete,
prava na korištenje vašeg doprinosa. Za detalje posjetite <https://cla.opensource.microsoft.com>.

Kada podnesete zahtjev za povlačenje, CLA bot će automatski odrediti trebate li pružiti
CLA i primjerice ukrasiti PR (status provjera, komentar). Jednostavno slijedite upute
koje daje bot. To ćete morati napraviti samo jednom za sve spremišta koja koriste naš CLA.

Ovaj projekt je usvojio [Microsoftov Kodeks ponašanja za otvoreni izvor](https://opensource.microsoft.com/codeofconduct/).
Za više informacija pogledajte [FAQ za Kodeks ponašanja](https://opensource.microsoft.com/codeofconduct/faq/) ili
kontaktirajte [opencode@microsoft.com](mailto:opencode@microsoft.com) za dodatna pitanja ili komentare.

## Zaštitni znakovi

Ovaj projekt može sadržavati zaštitne znakove ili logotipe za projekt, proizvode ili usluge. Ovlaštena upotreba Microsoftovih
zaštitnih znakova ili logotipa podliježe i mora slijediti
[Microsoftova pravila za korištenje zaštitnih znakova i brendova](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Korištenje Microsoftovih zaštitnih znakova ili logotipa u modificiranim verzijama ovog projekta ne smije izazivati zabunu niti implicirati Microsoftovo sponzorstvo.
