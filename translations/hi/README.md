# शुरुआती के लिए AI एजेंट्स - एक कोर्स

![शुरुआती के लिए AI एजेंट्स](../../translated_images/hi/repo-thumbnailv3.917487e234b90100.webp)

## AI एजेंट्स बनाने की शुरुआत करने के लिए आपको जो कुछ भी जानना जरूरी है, वह यह कोर्स सिखाता है
...
[![GitHub पुल अनुरोध](https://img.shields.io/github/issues-pr/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/pulls/?WT.mc_id=academic-105485-koreyst)
[![पीआर स्वागत है](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=academic-105485-koreyst)

### 🌐 बहुभाषी समर्थन

#### GitHub एक्शन के माध्यम से समर्थित (स्वचालित एवं हमेशा अपडेटेड)
...
>
> इस रिपॉजिटरी में 50+ भाषा के अनुवाद शामिल हैं, जो डाउनलोड साइज को काफी बढ़ा देते हैं। बिना अनुवादों के क्लोन करने के लिए sparse checkout का उपयोग करें:
>
> **Bash / macOS / Linux:**
> ```bash
...
> ```
>
> इससे आपको कोर्स पूरा करने के लिए आवश्यक सब कुछ मिलेगा और डाउनलोड काफी तेज़ होगा।
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

**यदि आप अतिरिक्त अनुवाद भाषाएँ चाहते हैं, तो वे [यहां](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md) सूचीबद्ध हैं।**
...
इस कोर्स में AI एजेंट्स बनाने की मूल बातें शामिल हैं। प्रत्येक पाठ अपना विषय कवर करता है, इसलिए जहाँ चाहें शुरुआत करें!

इस कोर्स के लिए बहुभाषी समर्थन उपलब्ध है। हमारी [उपलब्ध भाषाएँ यहां देखें](#-multi-language-support).

यदि आप पहली बार जेनरेटिव AI मॉडल्स के साथ काम कर रहे हैं, तो हमारा [Generative AI For Beginners](https://aka.ms/genai-beginners) कोर्स देखें, जिसमें GenAI के साथ निर्माण के 21 पाठ हैं।
...
### अन्य सीखने वालों से मिलें, अपने सवाल पूछें

यदि आप फंसे हुए हैं या AI एजेंट्स निर्माण को लेकर कोई सवाल है, तो हमारे समर्पित डिस्कॉर्ड चैनल में शामिल हों [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord) पर।

### आपको क्या चाहिए

इस कोर्स का प्रत्येक पाठ कोड उदाहरणों के साथ आता है, जो code_samples फोल्डर में पाए जा सकते हैं। आप [इस रिपॉजिटरी को फोर्क करें](https://github.com/microsoft/ai-agents-for-beginners/fork) अपनी कॉपी बनाने के लिए।  

इन अभ्यासों में कोड उदाहरण Microsoft Agent Framework और Microsoft Foundry Agent Service V2 का उपयोग करते हैं:

- [Microsoft Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - Azure खाता आवश्यक

इस कोर्स में Microsoft के निम्न AI एजेंट फ्रेमवर्क और सेवाओं का उपयोग होता है:

- [Microsoft Agent Framework (MAF)](https://learn.microsoft.com/agent-framework/overview/)
- [Microsoft Foundry Agent Service V2](https://aka.ms/ai-agents-beginners/ai-agent-service)

कुछ कोड उदाहरण वैकल्पिक OpenAI-समर्थित प्रदाताओं को भी सपोर्ट करते हैं जैसे [MiniMax](https://platform.minimaxi.com/), जो बड़े-संदर्भ मॉडल (204K टोकन तक) प्रदान करता है। विन्यास विवरण के लिए [Course Setup](./00-course-setup/README.md) देखें।

इस कोर्स के कोड चलाने के बारे में अधिक जानकारी के लिए [Course Setup](./00-course-setup/README.md) देखें।

## 🙏 मदद करना चाहते हैं?

क्या आपके पास सुझाव हैं या आपने कोई वर्तनी या कोड त्रुटि पाई है? [इश्यू उठाएँ](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) या [पुल अनुरोध बनाएँ](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 प्रत्येक पाठ में शामिल है

- एक लिखित पाठ जो README में है और एक छोटा वीडियो
- Microsoft Agent Framework और Microsoft Foundry के साथ पायथन कोड उदाहरण
- आपके सीखने को जारी रखने के लिए अतिरिक्त संसाधनों के लिंक


## 🗃️ पाठ

| **पाठ**                                   | **पाठ्य एवं कोड**                                    | **वीडियो**                                                  | **अतिरिक्त सीखने के संसाधन**                                                                     |
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| AI एजेंट्स और उनके उपयोग का परिचय       | [लिंक](./01-intro-to-ai-agents/README.md)          | [वीडियो](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [लिंक](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| उत्पादन में एआई एजेंट                      | [लिंक](./10-ai-agents-production/README.md)        | [वीडियो](https://youtu.be/l4TP6IyJxmQ?si=31dnhexRo6yLRJDl)  | [लिंक](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| माइक्रोसॉफ्ट एजेंट फ्रेमवर्क एक्सप्लोरिंग                        | [लिंक](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| कंप्यूटर उपयोग एजेंट (CUA) बनाना           | [लिंक](./15-browser-use/README.md)     |                                                            | [लिंक](https://docs.browser-use.com/examples/templates/playwright-integration)         |
| स्केलेबल एजेंट्स तैनात करना                    | [लिंक](./16-deploying-scalable-agents/README.md) |                                                    | [लिंक](https://learn.microsoft.com/azure/ai-foundry/agents/overview)                   |
| स्थानीय एआई एजेंट्स बनाना                     | [लिंक](./17-creating-local-ai-agents/README.md)  |                                                    | [लिंक](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)                    |
| एआई एजेंट्स को सुरक्षित बनाना                           | [लिंक](./18-securing-ai-agents/README.md)  |                                                            | [लिंक](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
[![शुरुआत के लिए एआई एजेंट्स](https://img.shields.io/badge/AI%20Agents%20for%20Beginners-00C49A?style=for-the-badge&labelColor=E5E7EB&color=00C49A)](https://github.com/microsoft/ai-agents-for-beginners?WT.mc_id=academic-105485-koreyst)
...
एजेंटिक RAG को दर्शाने वाले महत्वपूर्ण कोड नमूनों में योगदान के लिए [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) का धन्यवाद।

## योगदान करना

यह परियोजना योगदान और सुझावों का स्वागत करती है। अधिकांश योगदानों के लिए आपको एक
योगदानकर्ता लाइसेंस अनुबंध (CLA) पर सहमति देना आवश्यक होता है जिसमें यह घोषित होता है कि आपके पास हमारे लिए
अपने योगदान के उपयोग के अधिकार हैं और वास्तव में आपने हमें ये अधिकार दिए हैं। विवरण के लिए देखें <https://cla.opensource.microsoft.com>।

जब आप कोई पुल अनुरोध (pull request) भेजते हैं, तो एक CLA बॉट स्वचालित रूप से निर्धारित करेगा कि क्या आपको CLA प्रदान करना आवश्यक है
और पीआर को उपयुक्त रूप से सजाएगा (जैसे, स्थिति जांच, टिप्पणी)। बस बॉट द्वारा दी गई निर्देशों का पालन करें।
आपको यह केवल उन सभी रिपॉजिटरीज़ में एक बार करना होगा जो हमारे CLA का उपयोग करती हैं।
...
किसी भी अतिरिक्त प्रश्न या सुझाव के लिए [opencode@microsoft.com](mailto:opencode@microsoft.com) से संपर्क करें।

## ट्रेडमार्क

इस परियोजना में परियोजनाओं, उत्पादों, या सेवाओं के ट्रेडमार्क या लोगो हो सकते हैं। Microsoft के
ट्रेडमार्क या लोगो का अधिकृत उपयोग उन नियमों के अधीन है और उन्हें पालन करना आवश्यक है
...
किसी भी तीसरे पक्ष के ट्रेडमार्क या लोगो का उपयोग उन तीसरे पक्ष की नीतियों के अधीन होता है।
...
यदि आपके पास उत्पाद फ़ीडबैक है या निर्माण के दौरान कोई त्रुटि आती है, तो जाएं:
