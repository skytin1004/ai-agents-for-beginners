...
![初學者的 AI 代理](../../translated_images/zh-MO/repo-thumbnailv3.917487e234b90100.webp)

## 教授你開始構建 AI 代理所需知道的一切課程
...
> **喜歡本地克隆？**
>
> 此存儲庫包含 50 多種語言翻譯，顯著增加了下載大小。若要克隆不包含翻譯的版本，可使用稀疏檢出：
>
> **Bash / macOS / Linux：**
> ```bash
...
這門課程涵蓋構建 AI 代理的基礎知識。每課包含獨立主題，您可以從任何一課開始學習！

本課程提供多語言支援。請參閱我們的 [可用語言](#-multi-language-support)。

如果您是第一次使用生成式 AI 模型，請查看我們的 [初學者生成式 AI](https://aka.ms/genai-beginners) 課程，包含 21 節由淺入深的生成式 AI 构建課程。

別忘了為此倉庫 [點星 (🌟)](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst)，並 [分叉此倉庫](https://github.com/microsoft/ai-agents-for-beginners/fork) 來運行代碼。

### 認識其他學習者，解答你的疑問

如果遇到困難或有任何有關構建 AI 代理的問題，歡迎加入我們專屬的 Discord 頻道 [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord)。

### 所需條件

本課程每堂課均含示範代碼，位於 code_samples 資料夾。您可以 [分叉此倉庫](https://github.com/microsoft/ai-agents-for-beginners/fork) 創建自己的副本。
...
- [Microsoft 代理框架 (MAF)](https://learn.microsoft.com/agent-framework/overview/)
- [Microsoft Foundry 代理服務 V2](https://aka.ms/ai-agents-beginners/ai-agent-service)

部分示範代碼同時支援替代的 OpenAI 兼容提供者，如提供大上下文模型（最高可達 204K 代幣）的 [MiniMax](https://platform.minimaxi.com/)。配置細節請參閱 [課程設置](./00-course-setup/README.md)。

進一步了解如何運行本課程代碼，請參閱 [課程設置](./00-course-setup/README.md)。

## 🙏 想幫忙嗎？

如果您有建議或者發現拼字或程式碼錯誤，歡迎 [提出問題](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) 或 [發起拉取請求](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)。



## 📂 每堂課內容包含

- 置於 README 的書面課程與簡短影片
- 使用 Microsoft 代理框架結合 Microsoft Foundry 的 Python 程式碼範例
- 連結額外資源以持續學習


## 🗃️ 課程列表

| <strong>課程</strong>                                   | <strong>文本與代碼</strong>                                    | <strong>影片</strong>                                                  | <strong>額外學習</strong>                                                                     |
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| AI 代理介紹及使用案例                        | [連結](./01-intro-to-ai-agents/README.md)           | [影片](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)   | [連結](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |
...
| 代理 RAG                                   | [連結](./05-agentic-rag/README.md)                  | [影片](https://youtu.be/WcjAARvdL7I?si=gKPWsQpKiIlDH9A3)   | [連結](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |
| 構建值得信賴的 AI 代理                      | [連結](./06-building-trustworthy-agents/README.md)  | [影片](https://youtu.be/iZKkMEGBCUQ?si=jZjpiMnGFOE9L8OK )  | [連結](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |
...
| 使用代理協定 (MCP、A2A 和 NLWeb) | [連結](./11-agentic-protocols/README.md)           | [影片](https://youtu.be/X-Dh9R3Opn8)                                 | [連結](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| 建立電腦操作代理 (CUA)           | [連結](./15-browser-use/README.md)     |                                                            | [連結](https://docs.browser-use.com/examples/templates/playwright-integration)         |
...
| AI 代理的安全                           | [連結](./18-securing-ai-agents/README.md)  |                                                            | [連結](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
[![擴增實境開發新手入門](https://img.shields.io/badge/XR%20Development%20for%20Beginners-38BDF8?style=for-the-badge&labelColor=E5E7EB&color=38BDF8)](https://github.com/microsoft/xr-development-for-beginners?WT.mc_id=academic-105485-koreyst)
...
感謝 [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) 貢獻重要的程式碼範例來展示 Agentic RAG。 

## 貢獻

本專案歡迎貢獻與建議。大多數貢獻需要你同意
貢獻者授權協議 (CLA)，聲明你有權利且確實授予我們
使用你的貢獻的權利。詳情請參閱 <https://cla.opensource.microsoft.com>。

當你提交拉取請求時，CLA 機器人會自動判斷你是否需要提供
CLA，並適當裝飾 PR（例如狀態檢查、評論）。只要遵循機器人提供的指示即可。
你只需在所有使用我們 CLA 的倉庫中完成一次此流程。
...
商標或標誌須遵守並遵循
[Microsoft 的商標和品牌指南](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general)。
在修改版本的專案中使用 Microsoft 商標或標誌，不得造成混淆或暗示 Microsoft 贊助。
對第三方商標或標誌的任何使用，須遵守該第三方的政策。

## 尋求協助


若遇到困難或有任何關於建立 AI 應用程式的問題，歡迎加入：
