...
[![Incidencias de GitHub](https://img.shields.io/github/issues/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/issues/?WT.mc_id=academic-105485-koreyst)
...
>
> Este repositorio incluye más de 50 traducciones de idiomas lo que incrementa significativamente el tamaño de la descarga. Para clonar sin traducciones, usa checkout parcial:
>
> **Bash / macOS / Linux:**
> ```bash
...
**Si deseas que se soporten idiomas adicionales para la traducción, están listados [aquí](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md).**
...
Este curso tiene lecciones que cubren los fundamentos para construir Agentes de IA. Cada lección cubre su propio tema, ¡así que empieza donde quieras!

Hay soporte multilenguaje para este curso. Ve a nuestros [idiomas disponibles aquí](#-multi-language-support). 

Si esta es tu primera vez construyendo con modelos de IA Generativa, consulta nuestro curso [Inteligencia Artificial Generativa Para Principiantes](https://aka.ms/genai-beginners), que incluye 21 lecciones sobre construcción con GenAI.

No olvides [estrellar (🌟) este repositorio](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) y [hacer un fork de este repositorio](https://github.com/microsoft/ai-agents-for-beginners/fork) para ejecutar el código.
...
Cada lección en este curso incluye ejemplos de código, los cuales puedes encontrar en la carpeta code_samples. Puedes [hacer un fork de este repositorio](https://github.com/microsoft/ai-agents-for-beginners/fork) para crear tu propia copia.  
...
Algunos ejemplos de código también soportan proveedores alternativos compatibles con OpenAI como [MiniMax](https://platform.minimaxi.com/), que ofrece modelos de contexto grande (hasta 204K tokens). Consulta la sección de [Configuración del Curso](./00-course-setup/README.md) para detalles de configuración.

Para más información sobre cómo ejecutar el código para este curso, visita la [Configuración del Curso](./00-course-setup/README.md).

## 🙏 ¿Quieres ayudar?

¿Tienes sugerencias o encontraste errores ortográficos o de código? [Abre un issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) o [crea una solicitud de extracción](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Enlaces a recursos extra para continuar aprendiendo
...
| Explorando Frameworks de Agentes            | [Enlace](./02-explore-agentic-frameworks/README.md)| [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Enlace](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Entendiendo Patrones de Diseño de Agentes  | [Enlace](./03-agentic-design-patterns/README.md)   | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Enlace](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| RAG Agentic                               | [Enlace](./05-agentic-rag/README.md)               | [Video](https://youtu.be/WcjAARvdL7I?si=gKPWsQpKiIlDH9A3)  | [Enlace](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Creación de Agentes de Uso Informático (CUA)     | [Link](./15-browser-use/README.md)     |                                                            | [Link](https://docs.browser-use.com/examples/templates/playwright-integration)         |
| Despliegue de Agentes Escalables                | [Link](./16-deploying-scalable-agents/README.md) |                                                    | [Link](https://learn.microsoft.com/azure/ai-foundry/agents/overview)                   |
...
Gracias a [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) por contribuir con muestras importantes de código que demuestran Agentic RAG.

## Contribuciones

Este proyecto acepta contribuciones y sugerencias. La mayoría de las contribuciones requieren que aceptes un
Acuerdo de Licencia para Contribuidores (CLA) declarando que tienes el derecho, y efectivamente lo haces, de otorgarnos
...
un CLA y decorará la PR apropiadamente (p. ej., chequeo de estado, comentario). Simplemente sigue las instrucciones
proporcionadas por el bot. Solo tendrás que hacerlo una vez para todos los repositorios que usan nuestro CLA.
...
marcas o logotipos de Microsoft está sujeto y debe seguir
...
Si te atascas o tienes preguntas sobre cómo crear aplicaciones de IA, únete a:
